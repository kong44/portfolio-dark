        ...
        <div className="lg:col-span-1 space-y-6">
          <Card>
            ...
            <div className="flex flex-wrap gap-4">
              {programmingLanguage.map((item,index) => <img key={`programming_${index}`} src={item} className="w-8 h-8" />)}
            </div>
          </Card>
          <Card>
            <h3 className="text-light-gray mb-4">Development Tools</h3>
            <div className="flex flex-wrap gap-4">
              {developmentTools.map((item,index) => <img key={`dev_${index}`} src={item} className="w-8 h-8" />)}
            </div>
          </Card>
          <Card>
            <h3 className="text-light-gray mb-4">Languages</h3>
            <div className="flex flex-wrap gap-4">
              {languages.map((item, index) => <img key={`lang_${index}`} src={item} className="w-8 h-8 rounded-md object-cover" />)}
            </div>
          </Card>
        </div>
